...
export const metadata: Metadata = {
  title: 'Microsoft SPLA Services Agreement | Tech Noir Global',
  description: 'Public Offer Agreement for Microsoft SPLA Cloud Services and Infrastructure provided by Tech Noir Global Inc.',
}

const publicOfferingContent = `# Public Offer Agreement for Microsoft SPLA Cloud Services
...
const components: Components = {
  ...
  h2: (props) => (
    <h2 className="text-3xl font-semibold mb-6 mt-12 text-gray-100" {...props} />
  ),
  h3: (props) => (
    <h3 className="text-2xl font-semibold mb-4 mt-8 text-gray-200" {...props} />
  ),
  p: (props) => (
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <article className="bg-gray-800 rounded-lg shadow-xl p-8 md:p-12">
          <ReactMarkdown components={components}>{publicOfferingContent}</ReactMarkdown>
        </article>
      </div>
    </div>
  )
